...
const reloadUser = async (data) => {
  ...
  $('div-img.avatar').css('background-image', `url(https://cdn.discordapp.com/avatars/${discordId}/${data.discord_user.avatar}.pnd?size=1024)`).removeAttr('loading');
...
function showGithubRepos() {
  const getGitHubData = async () => {
    const response = await fetch(properties.github_api.baseURL + '/users/MrRubby/repos');
  ...
  const socials = [
    {
      ...
      href: 'https://instagram.com/ayazisgood',
      tippy: 'Instagram'
    },
    {
      ...
      href: 'mailto:ayaz25138@gmal.com',
      tippy: 'E-Mail'
    },
    {
      ...
      href: `https://discord.gg/y4mPbWjTTh`,
      tippy: 'Discord'
    },
    {
